...
<body>
    <div class="wrapper">
        <div class="grid grid-cols-14">
            ...
            <form action="{{route('addKegiatan.post')}}" method="POST">
                @csrf
                <h1 class="absolute text-secondary pt-12">Tambah Kegiatan</h1>
               
                    <div class="rounded-sm absolute top-20 w-8/12 pb-5 bg-danger items-center z-0">
                        <div class="flex flex-wrap px-4">
                            <div class="flex flex-col my-2 px-2 w-full md:w-full lg:w-full xl:w-full">
                                <div class="flex flex-col pl-8">
                                    ...
                                    <input name="nama_kegiatan" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-96 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your Name">                      
                                    ...
                                    <label for="date" class="pt-3 text-base font-medium">Tanggal</label>
                                        <div date-rangepicker class="flex items-center">
                                            <div class="relative">
                                                ...
                                                <input name="tanggal_mulai" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-96 pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date start">
                                            </div>
                                            ...
                                            <div class="relative">
                                                ...
                                                <input name="tanggal_selesai" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-96 pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date end">
                                            </div>
                                        </div>
                                </div>
                        </div>
                    </div>
                <div class="relative flex flex-row mt-60 left-2/3">
                    <div class="px-2">
